...
#     def handle_home_navigation(self, destination: str):
...
#     def show_ref_page(self, data: dict):
...
#             self.db_window = DatabaseMonitorWindow(
#                 master=self,
#             )
...
# #         self.current_page = FolderPage(
# #             self,
# #             on_back=self.show_home_page,
# #             on_next=self.show_ref_page,
# #         )

# #     def show_ref_page(self, data):
